...
{#\hfil\tabskip1em&\hfil$#$\hfil&#\hfil&#\hfil\tabskip\@centering\cr
  \atexp& ::=	& \scon 	& special constant\cr\adhocdeletion{\theidstatus}{0cm}{
        & 	& \opp\longvar	& value variable\cr
	&	& \opp\longcon	& value constructor\cr
        &       & \opp\longexn  & exception constructor\cr}\adhocinsertion{\theidstatus}{-2cm}{        & 	& \opp\longvid	& value identifier\cr}
...
\noalign{\vspace{6pt}}
\inexp & ::=	& \apexp	& \cr
        &   	& \adhocreplacementl{\theidstatus}{3cm}{$\inexp_1$\ \id\ $\inexp_2$}{$\inexp_1$\ \vid\ $\inexp_2$}
                                & infix expression\cr
\noalign{\vspace{6pt}}
  \exp  & ::=	& \inexp 	& \cr
	&	& \typedexp	& typed (L)\cr
...
\fvalbind& ::=  & \ \ $\langle\OP\rangle\var\ \atpat_{11}\cdots\atpat_{1n}
        ...
        &       & \qquad\qquad\qquad$\langle\AND\ \fvalbind\rangle$ &\cr}\adhocinsertion{\theidstatus}{2cm}{\fvalbind& ::=  & \ \ $\langle\OP\rangle\vid\ \atpat_{11}\cdots\atpat_{1n}
                  \langle$\ml{:}\ty$\rangle$\ml{=}\exp$_1$ & $m,n\geq 1$\cr
...
\noalign{\vspace{6pt}}
\constrs& ::=	& \adhocreplacementl{\theidstatus}{4cm}{\opp\longconstrs}{\opp\longvidconstrs} & \cr
\noalign{\vspace{6pt}}
\exnbind& ::=	& \adhocreplacementl{\theidstatus}{4cm}{\generativeexnbind}{\generativeexnvidbind}	& \cr
        &       & \adhocreplacementl{\theidstatus}{4cm}{\eqexnbind}{\eqexnvidbind}   & \cr
\noalign{\vspace{6pt}}
}
\makeatother
\vspace{3pt}
Note: \adhocreplacementl{\theidstatus}{3cm}{In the $\fvalbind$ form, if $\var$ has infix status then either
...
\noalign{\vspace{6pt}}
  \pat	& ::=	& \atpat	& atomic\cr\adhocdeletion{\theidstatus}{0cm}{
	...
	&	& \typedpat	& typed\cr
	&	& \opp\layeredpat	& layered\cr}\adhocinsertion{\theidstatus}{2cm}{	&	& \opp\vidpat	& constructed value\cr
	&	& \vidinfpat       & constructed value (infix)\cr
	&	& \typedpat	& typed\cr
	&	& \opp\layeredvidpat	& layered\cr}
\noalign{\vspace{6pt}}
}
\makeatother
\vspace{3pt}
